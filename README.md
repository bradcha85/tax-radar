...
② 매입세액 = 과세 매입 ÷ 11
③ 의제매입세액공제 = min(면세 식재료, 과세표준 × 한도율) × 공제율
   - 공제율(음식점/카페): 9/109 (2026.12.31까지, 과세표준 2억 이하), 그 외 8/108
   - 한도율(2027.12.31까지 특례, 음식점/카페): 1억↓ 75%, 2억↓ 70%, 초과 60%
④ 신카발행세액공제 = (카드 + 현금영수증) × 공제율, 연간 한도 적용
   - 공제율: 1.3% (2026.12.31까지), 그 외 1.0%
   - 연간 한도: 1,000만원 (2026.12.31까지), 그 외 500만원
```
