...
const List<GlossaryTerm> kGlossaryTerms = [
  ...
  GlossaryTerm(
    ...
    title: '총세금(결정)',
    description:
        '모든 공제·감면을 반영한 후 최종 확정된 세금이에요. 이 앱에서는 종소세+지방소득세에 농어촌특별세(해당 시)를 더해 합산해서 보여줘요.',
    category: '종소세',
  ...
  GlossaryTerm(
    ...
    title: '감면·세액공제',
    description:
        '산출세액에서 직접 빼서 세금을 줄여주는 항목이에요. 창업감면(세액감면)이나 고용증대 세액공제처럼 종류가 다양해요. 이 앱에서는 감면/세액공제를 합산해 “차감세액”으로 보여줘요.',
    category: '공제',
    whereToFind: ['홈택스 신고서 → \'세액감면 및 세액공제\' 항목', '세무대리인 제공 신고서 요약표'],
  ),
  GlossaryTerm(
    id: 'T15',
    title: '인적공제',
  ...
  GlossaryTerm(
    ...
    title: '창업감면',
    description:
        '창업 후 일정 기간 동안 소득세를 비율로 줄여주는 제도예요(예: 50%/75%/100%). 지역·업종·연도·청년 여부 등에 따라 적용 여부와 비율이 달라질 수 있어요.',
    category: '공제',
    whereToFind: ['홈택스 신고서 → \'세액감면\' 항목', '세무대리인에게 감면율 확인'],
  ),
  GlossaryTerm(
    id: 'T32',
    title: '고용증대 세액공제',
    description:
        '4대보험 가입 근로자 수가 증가한 경우 세금을 공제받을 수 있는 제도예요. 공제 가능 여부와 금액은 요건(근로자 정의, 제외 대상 등)에 따라 달라질 수 있어요.',
    category: '공제',
    whereToFind: ['홈택스 신고서 → \'세액공제\' 항목', '4대보험 가입자 명부, 급여대장'],
  ),
  GlossaryTerm(
    id: 'T33',
    title: '농어촌특별세',
    description:
        '일부 감면·공제를 받으면 추가로 붙는 세금이에요. 감면/공제 금액과 종류에 따라 농어촌특별세가 발생할 수 있어요.',
    category: '종소세',
    whereToFind: ['홈택스 신고서 → \'농어촌특별세\' 항목(해당 시)'],
  ),
  GlossaryTerm(
    id: 'T34',
    title: '자녀세액공제',
    description:
        '만 8세 이상 만 20세 이하 자녀가 있으면(그리고 자녀의 소득금액이 100만 원 이하인 경우) 세금을 직접 깎아주는 공제예요. 이 앱은 입력한 “대상 자녀 수”를 기준으로 1명 25만 원, 2명 55만 원, 3명 이상은 55만 원 + (2명 초과 1명당 40만 원)으로 계산해요.',
    category: '공제',
    whereToFind: ['홈택스 신고서 → \'세액공제\' 또는 \'자녀세액공제\' 항목'],
  ),
  GlossaryTerm(
    id: 'V01',
    title: '부가세',
