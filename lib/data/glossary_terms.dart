...
const List<GlossaryTerm> kGlossaryTerms = [
  ...
  GlossaryTerm(
    ...
    title: '노란우산',
    description:
        '소기업·소상공인 공제부금(노란우산)에 납입한 금액을 소득에서 공제해 줘요. 연간 최대 500만 원까지 공제 가능해요.',
    category: '공제',
  ...
  GlossaryTerm(
    ...
    title: '의제매입',
    description:
        '부가세가 면제되는 농·축·수산물 등 식재료를 매입했을 때 일정 비율을 공제받는 제도예요. 음식점·카페에 해당돼요.',
    category: '부가세',
    whereToFind: ['면세 식재료 매입 영수증·계산서', '전체 지출이 아닌 면세 매입액만 입력'],
  ),
  GlossaryTerm(
    id: 'V06',
    title: '신카 공제',
    description:
        '신용카드·현금영수증으로 매출이 발생했을 때 일정 금액을 공제받는 제도예요. 연간 한도(최대 1,000만 원)가 있어요.',
    category: '부가세',
