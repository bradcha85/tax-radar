...
const List<GlossaryTerm> kGlossaryTerms = [
  GlossaryTerm(
    id: 'T01',
    title: '종소세',
    description: '1년간 벌어들인 모든 소득(사업·근로·연금 등)을 합산해서 매기는 세금이에요. 매년 5월에 전년도분을 신고·납부해요.',
    category: '종소세',
  ...
  GlossaryTerm(
    id: 'T04',
    title: '기납부세액',
    description: '1년 동안 원천징수·중간예납 등으로 이미 낸 세금의 합계예요. 정확히 입력할수록 추가 납부/환급 예측이 맞아져요.',
    category: '기납부',
  ...
  GlossaryTerm(
    id: 'T07',
    title: '사업소득',
    description: '음식점·카페·프리랜서 등 사업으로 벌어들인 소득이에요. 매출에서 필요경비를 빼서 계산해요. 종소세에서는 VAT를 제외한 매출을 기준으로 해요.',
    category: '소득',
    whereToFind: [
      '홈택스 → 전자세금계산서 조회',
  ...
  GlossaryTerm(
    id: 'T08',
    title: '필요경비',
    description: '사업을 위해 쓴 비용(임차료·재료비·인건비 등)이에요. 경비가 많을수록 소득금액이 줄어 세금이 낮아져요. 부가세 매입과는 범위가 다를 수 있어요.',
    category: '소득',
  ...
  GlossaryTerm(
    id: 'T11',
    title: '누진세율',
    description: '과세표준이 높을수록 세율도 올라가는 구조예요(6%~45%). 구간별로 나눠서 계산하기 때문에 전체에 최고세율이 적용되지는 않아요.',
    category: '종소세',
  ...
  GlossaryTerm(
    id: 'T14',
    title: '세액공제',
    description: '이미 계산된 세금에서 직접 빼주는 공제예요. 10만 원 공제되면 세금이 10만 원 줄어들어요. 연금계좌 세액공제 등이 있어요.',
    category: '공제',
  ...
  GlossaryTerm(
    id: 'T16',
    title: '노란우산',
    description: '소기업·소상공인 공제부금(노란우산)에 납입한 금액을 소득에서 공제해 줘요. 연간 최대 500만 원까지 공제 가능해요.',
    category: '공제',
  ...
  GlossaryTerm(
    id: 'T18',
    title: '원천징수',
    description: '소득을 지급받을 때 미리 떼인 세금이에요. 이 금액이 기납부세액에 포함되어 추가 납부/환급 계산에 직접 영향을 줘요.',
    category: '기납부',
  ...
  GlossaryTerm(
    id: 'T19',
    title: '중간예납',
    description: '전년도 종소세의 절반을 11월에 미리 내는 제도예요. 납부한 금액이 있으면 기납부세액에 포함되어 추가 납부액이 줄어들어요.',
    category: '기납부',
  ...
  GlossaryTerm(
    id: 'T20',
    title: '금융 과세',
    description: '이자·배당 등 금융소득이 연 2,000만 원을 넘으면 다른 소득과 합산과세돼요. 2,000만 원 이하는 원천징수(15.4%)로 분리과세돼요.',
    category: '소득',
  ...
  GlossaryTerm(
    id: 'T21',
    title: '귀속연도',
    description: '소득이 실제로 발생한 연도를 말해요. 2025년에 번 소득은 귀속연도 2025년이고, 2026년 5월에 신고·납부해요.',
    category: '종소세',
  ...
  GlossaryTerm(
    id: 'T22',
    title: '정밀도',
    description: '입력한 항목이 얼마나 정확한지를 나타내는 점수예요. 직접 입력한 값이 많을수록 높고, 추정·미입력이 많을수록 낮아져요.',
    category: '정밀도',
  ...
  GlossaryTerm(
    id: 'T23',
    title: '추정',
    description: '\'모르겠어요\'를 선택하면 앱이 평균값으로 대신 채워주는 값이에요. 실제와 차이가 있을 수 있어서 정밀도가 낮아져요.',
    category: '정밀도',
  ...
  GlossaryTerm(
    id: 'T24',
    title: '기장신고',
    description: '장부에 기록된 실제 매출과 경비를 기반으로 신고하는 방식이에요. 단순경비율 방식보다 정확하고, 세금이 유리할 수 있어요.',
    category: '소득',
  ...
  GlossaryTerm(
    id: 'T25',
    title: '단순경비율',
    description: '실제 경비 대신 국세청이 업종별로 정한 비율로 경비를 추정하는 방식이에요. 장부가 없을 때 간편하지만, 실제보다 불리할 수 있어요.',
    category: '소득',
  ...
  GlossaryTerm(
    id: 'T26',
    title: '분리과세',
    description: '다른 소득과 합산하지 않고 별도의 세율로 과세가 끝나는 방식이에요. 금융소득 2,000만 원 이하 등이 해당돼요.',
    category: '소득',
  ...
  GlossaryTerm(
    id: 'T27',
    title: '종합과세',
    description: '여러 소득을 합산해서 누진세율로 과세하는 방식이에요. 금융소득이 연 2,000만 원을 넘으면 종합과세 대상이 돼요.',
    category: '소득',
  ...
  GlossaryTerm(
    id: 'T28',
    title: '증빙',
    description: '소득이나 지출 금액을 증명하는 서류(영수증·세금계산서·원천징수영수증 등)예요. 증빙이 있으면 가장 정확하게 입력할 수 있어요.',
    category: '기타',
  ...
  GlossaryTerm(
    id: 'V01',
    title: '부가세',
    description: '물건이나 서비스를 팔 때 붙는 10% 세금이에요. 1기(1~6월)와 2기(7~12월)로 나눠 반기마다 신고·납부해요.',
    category: '부가세',
  ...
  GlossaryTerm(
    id: 'V05',
    title: '의제매입',
    description: '부가세가 면제되는 농·축·수산물 등 식재료를 매입했을 때 일정 비율을 공제받는 제도예요. 음식점·카페에 해당돼요.',
    category: '부가세',
  ...
  GlossaryTerm(
    id: 'V06',
    title: '신카 공제',
    description: '신용카드·현금영수증으로 매출이 발생했을 때 일정 금액을 공제받는 제도예요. 연간 한도(최대 1,000만 원)가 있어요.',
    category: '부가세',
  ...
  GlossaryTerm(
    id: 'V07',
    title: '과세기간',
    description: '부가세를 계산하는 기간 단위예요. 1기(1~6월, 7월 신고)와 2기(7~12월, 다음 해 1월 신고)로 나뉘어요.',
    category: '부가세',
  ...
  GlossaryTerm(
    id: 'V08',
    title: 'VAT 포함',
    description: '입력하는 매출 금액에 부가세(10%)가 포함되어 있는지 여부예요. 소비자에게 받는 가격은 보통 VAT 포함이에요.',
    category: '부가세',
